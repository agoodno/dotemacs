...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cider yaml-mode yaml clojure-mode f erc-hipchatify js2-mode ensime ido-vertical-mode ido-mode company robe chruby bundler yari magit aggressive-indent html-mode restclient markdown-mode json-mode scala-mode use-package enh-ruby-mode bar-cursor auto-compile)))
