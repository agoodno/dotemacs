...
** General
   #+BEGIN_SRC emacs-lisp
     (use-package auto-complete
       ...
       (ac-config-default)
       (add-to-list 'ac-dictionary-directories "~/.emacs.d/auto-complete-config/dict")
...
*** Ruby
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package ac-inf-ruby
        :after (inf-ruby enh-ruby-mode auto-complete)
        :ensure t
        :init
...
** org-roam
   #+BEGIN_SRC emacs-lisp
     (use-package org-roam
       ...
       :custom
       (org-roam-directory (file-truename (concat (file-name-as-directory (getenv "HOME")) "org-roam-nodes")))
       :config
       (org-roam-setup)
