...
** IRC
   #+BEGIN_SRC emacs-lisp
     ...
     (setq
      ...
      p     ;; erc-server-flood-penalty 1000000
             ...
             `( ,(make-mu4e-context
                ...
                ,(make-mu4e-context
                  ...
                  :match-func (lambda (msg)
                                (when msg
                                  (mu4e-message-contact-field-matches msg
                                                                      :to "andrew.goodnough@icloud.com")))
                  :vars '((smtpmail-smtp-server . "imap.mail.me.com")
                          (smtpmail-smtp-service . 25)
