...
#+BEGIN_SRC emacs-lisp
  ...
  ;; fix https://github.com/greduan/emacs-theme-gruvbox/blob/master/gruvbox.el#L550, set :foreground gruvbox-dark1 to ;background gruvbox-dark1
  (use-package gruvbox-theme
    :ensure t
    :defer t
    :init
    (custom-set-faces '(magit-diff-context ((t (:extend t :background "#3c3836" :foreground "#fdf4c1"))))))
