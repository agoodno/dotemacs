...
* General config
** User variables
Load all the user-specific user variables from the ~secrets.el~
file. the variables don't have to be secret, just unique to the user
or machine that emacs is running on. To bootstrap, copy the
~secrets.el.sample~ to ~secrets.el~ and set the values as appropriate.

#+BEGIN_SRC emacs-lisp
  (defcustom notes-location "/path/to/notes/repo"
    "Set to the location of the checked out notes git repo."
    :type 'string
    :group 'agg)

  ;; load secrets after customize initialization so custom variable is not overwritten
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; see https://www.reddit.com/r/emacs/comments/bxt0cz/helm_and_the_tab_key/
  ;; (use-package helm
  ;;   :ensure t
  ;;   :bind
  ;;   ("M-x" . helm-M-x)
...
#+BEGIN_SRC emacs-lisp
  (use-package org-roam
    ...
    :custom
    ;; (org-roam-db-location "/Users/andrew/Library/Mobile Documents/com~apple~CloudDocs/Documents/org-roam.db")
...
*** Ruby
    #+BEGIN_SRC emacs-lisp
      ...
      (use-package enh-ruby-mode
        ...
        (setq rubocop-check-command "rubocop --format emacs --auto-correct")
