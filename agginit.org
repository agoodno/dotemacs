...
** Env vars
   #+BEGIN_SRC emacs-lisp
     ...
     (setq on_work_laptop (equal (system-name) "Andys-MacBook-Pro.local"))
     (setq on_home_laptop (equal (system-name) "Andrews-MBP"))

     (setq as_andy (equal user-login-name "andy"))
     (setq as_andrew (equal (user-login-name) "andrew"))

     (setq at_work (and on_work_laptop as_andy))
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package slack
      ...
      (slack-register-team
       ...
       :token "xoxs-12617974597-106280355140-593574482007-4fe62fad37a38d092366d42310121a0a72a77f29a4eb563851e6d96398bc140b"
